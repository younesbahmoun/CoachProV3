                        ...
                        <?php foreach($seances as $s): ?>
                            <div class="seance-card">
                                ...
                                <div class="seance-actions">
                                    <a href="action/modifier-seance.php?id=<?php echo htmlspecialchars((int)$s['id'], ENT_QUOTES, 'UTF-8'); ?>">
                                        <button class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i>
                                            Modifier
                                        </button>
                                    </a>
                                    <a href="action/delete-seance.php?id=<?php echo htmlspecialchars((int)$s['id'], ENT_QUOTES, 'UTF-8'); ?>">
